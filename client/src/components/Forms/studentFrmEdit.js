...
function StudentFrmAdd(props) {
    ...
    const AddStudent = async (data) => {
        try {
            if(data.rollno == props.obj.rollno){
                const response = await axios.put(`/student/${props.obj._id}`, data, {
                    headers: {
                        "Content-Type": "application/json",
                        "auth-token": authToken,
                    }
            ...
            }else
            {
                ...
                if(!(student.data.length>=1))
                {
                    ...
                    swal("Roll No Duplicated!", `${data.rollno} Record has already in use!`, "warning");
                }   
            }           
        ...
        <div className="pt-0 pb-5 pl-0 pr-0">
            <div className="row justify-content-sm-center pt-0">
                <div className="col-sm-10 shadow round pb-3 backgroundColor ">
                    <h1 className="text-center pt-3 text-secondary">Edit Student Form</h1>
                        ...
                        <div className="row">
                            ...
                            <div className="form-group col-md-6"> { /* Father Occupation */}
                                ...
                                <input
                                    ...
                                    defaultValue={props.obj.fatherOccupation}
                                />
                        ...
                        <div className="row">
                            ...
                            <div className="form-group col-md-4"> { /* Scholarship  */}
                                ...
                                <select
                                    ...
                                    defaultValue={props.obj.scholarship}
                                    >
                        ...
                        <div className="row">
                            <div className="form-group col-md-6"> { /* IsLocal  */}
                                ...
                                <select
                                    ...
                                    defaultValue={props.obj.isLocal}
                                    >
                        ...
                        <div className="row">
                            <div className=" col-md-6"> { /* DOB */}
                                ...
                                <input
                                    ...
                                    defaultValue={props.obj.dateOfBirth}
                                />
                                {errors.dateOfBirth && (
