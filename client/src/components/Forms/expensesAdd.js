...
function ExpensesAdd() {
    ...
    const AddExpenses = async (data) => {
        try {           
            ...
            const response = await axios.post("/expendetures", data , {
                headers: {
            ...
            if (response)
                swal("Great Gob!", `${data.title} has been added!`, "success");
            else
        ...
        <div className="container pt-5">
            <div className="row justify-content-sm-center pt-0">
                <div className="col-sm-10 shadow round pb-3 backgroundColor">
                    <h1 className="text-center pt-3 text-secondary">Add Expendeture Form</h1>
