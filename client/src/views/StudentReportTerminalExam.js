...
import EditResult from "../components/Forms/ResultEdit"
    ...
    <>   
      ...
      <div className="tab-content mt-2 mb-3" id="pills-tabContent">
        ...
        >
          ...
          <div className="col-md-2 card-header text-center my-2">
            <button
              onClick={handlePrint}
          ...
          <h6 style={{ textAlign: "center" }}>Contact # 090078601</h6> */}
            <div className="d-flex justify-content-center">
              <h3 style={{ color: "red" }}><b><u>Terminal Exams</u></b></h3>
            </div>
            <br></br>
